...
class Ui_PesananAdminWindow(object):
    def setupUi(self, PesananAdminWindow, ID_Pengguna=1):
        ...
        self.PesananAdminWindow.resize(899, 600)
...
"color: rgb(150, 150, 150);")
        ...
        self.tabel_pesan.setColumnCount(8)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tabel_pesan.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tabel_pesan.setHorizontalHeaderItem(7, item)
...
"}")
    ...
    def retranslateUi(self, PesananAdminWindow):
        ...
        item.setText(_translate("PesananAdminWindow", "Tanggal_Pesan"))
        item = self.tabel_pesan.horizontalHeaderItem(4)
        item.setText(_translate("PesananAdminWindow", "RS"))
        item = self.tabel_pesan.horizontalHeaderItem(5)
        item.setText(_translate("PesananAdminWindow", "Harga"))
        item = self.tabel_pesan.horizontalHeaderItem(6)
        item.setText(_translate("PesananAdminWindow", "Pasien_Sekarang"))
        item = self.tabel_pesan.horizontalHeaderItem(7)
        item.setText(_translate("PesananAdminWindow", "Kapasitas"))
